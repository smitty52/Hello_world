...
define("REMOTE_REPOSITORY", "git@github.com:smitty52/Hello_world"); // The SSH URL to your repository: "git@github.com:username/repository.git" https://github.com/smitty52/Hello_world
